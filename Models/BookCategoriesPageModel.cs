...
namespace Copos_Ionut_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Copos_Ionut_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Copos_Ionut_Lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
